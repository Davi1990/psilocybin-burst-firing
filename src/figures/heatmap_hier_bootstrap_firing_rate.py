...
Usage
-----
  python heatmap_hier_bootstrap.py --base_dir output_prestim_firing_rate
"""
...
# Share ONE colour bar across both comparisons of the figure. Only colour
...
def main():
    ...
    # Defer plotting so a shared colour scale can be computed across both
    # comparisons before anything is drawn.
    plot_jobs = []
    vmax_by_metric = {}
